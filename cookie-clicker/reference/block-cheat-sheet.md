...
| `play sound [sound] until done` | Plays that sound and makes the script sit and wait until it has finished. Not used anywhere in this course — it is the one the step cards warn you about picking by mistake, because a clicking game that waits for its own sound stalls. |
